...
async function fetchIAMoveJSON_hex(current_IA) {
    const response = await fetch('/hexiaia_mcts_place_piece', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ 'current_IA': current_IA }) });
